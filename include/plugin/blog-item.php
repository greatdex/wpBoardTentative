	...
	*/
	...
	if( $gdl_is_responsive ){
		$blog_div_size_num_class = array(
			"1/1 Full Thumbnail" => array("index"=>"2", "class"=>"sixteen columns", "size"=>"940x350", "size2"=>"640x240", "size3"=>"460x170", "size4"=>"250x188"));
	...
	function print_blog_full( $item_class, $item_size, $item_index, $num_excerpt ){
		...
		while( have_posts() ){
			...
			echo '<div class="cont">' . mb_substr( get_the_excerpt(), 0, $num_excerpt ) . '</div>';	
